...
class AnimatedRandomSquares extends StatefulWidget {
  ...
  @override
  _AnimatedSquaresState createState() => _AnimatedSquaresState();
}

class _AnimatedSquaresState extends State<AnimatedRandomSquares>
        ...
        builder: (BuildContext context, Widget? child) {
          return Stack(
            children: List.generate(100, (index) {
              final size = generateRandomValue(100);
